  ...
  <div id="people">
    <div class="left">
      <div class="peopleInfo">
        ...
        <div class="info">
          个人信息:
          <div>姓名：{{ healthData.researched_person_id }}</div>
          <div>性别：男</div>
          <div>年龄：74</div>
        </div>
      </div>
...
export default {
  ...
  created() {
    ...
    const data = JSON.parse(this.$route.query.data);
     // 现在你可以在这里处理接收到的数据（data）了
    console.log(data);
    this.healthData = data;
    this.leftData[0].currentNumber = this.healthData.temperature;
    this.leftData[1].currentNumber = this.healthData.breath_rate;
    
    this.leftData[3].currentNumber = this.healthData.blood_glucose;
    this.rightData[0].currentNumber = this.healthData.heart_rate;
    this.rightData[1].currentNumber = this.healthData.blood_oxygen;
    this.rightData[2].currentNumber = this.healthData.systolic;
    this.rightData[3].currentNumber = this.healthData.diastolic;
  ...
  methods: {
    ...
    loadSTL() {
      ...
      loader.load(`${THIS.publicPath}models/person.stl`, (geometry) => {
        // 创建材质
