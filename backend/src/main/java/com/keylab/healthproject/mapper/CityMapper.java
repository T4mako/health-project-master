...
public interface CityMapper {
    ...
    @Select("""
            ...
            SELECT
                month,
                SUM(L0_breath_rate) + SUM(L0_systolic) + SUM(L0_diastolic) +\s
                SUM(L0_blood_oxygen) + SUM(L0_temperature) + SUM(L0_heart_rate) +\s
                SUM(L0_blood_glucose) AS L0_count,
                SUM(L1_breath_rate) + SUM(L1_systolic) + SUM(L1_diastolic) +\s
                SUM(L1_blood_oxygen) + SUM(L1_temperature) + SUM(L1_heart_rate) +\s
                SUM(L1_blood_glucose) AS L1_count,
                SUM(L2_breath_rate) + SUM(L2_systolic) + SUM(L2_diastolic) +\s
                SUM(L2_blood_oxygen) + SUM(L2_temperature) + SUM(L2_heart_rate) +\s
                SUM(L2_blood_glucose) AS L2_count,
                SUM(L3_breath_rate) + SUM(L3_systolic) + SUM(L3_diastolic) +\s
                SUM(L3_blood_oxygen) + SUM(L3_heart_rate) +\s
                SUM(L3_blood_glucose) AS L3_count
